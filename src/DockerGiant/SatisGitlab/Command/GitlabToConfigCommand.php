...
namespace DockerGiant\SatisGitlab\Command;
...
use DockerGiant\SatisGitlab\Satis\ConfigBuilder;
...
use DockerGiant\SatisGitlab\GitFilter\GitlabNamespaceFilter;
...
class GitlabToConfigCommand extends Command {
    ...
    protected function configure(): void
    {
        ...
        $this
            ...
            ->setHelp('look for composer.json in default gitlab branch, extract project name and register them in SATIS configuration')
